...
public class SharedViewModel extends ViewModel {
  ...
  //  private int selectedItem3 = 0;
    ...
    public void Swap() {
        int temp = selectedItem2.getValue();
        setSelectedItem2(selectedItem3.getValue());
        setSelectedItem3(temp);
        String temp2 = getNumberToConvert().getValue();
        setNumberToConvert(getConvertedNumber().getValue());
        setConvertedNumber(temp2);
    }
    }
